...
export const UpdateApprovedTask: React.FC = () => {
    ...
    const taskStatuses = ['Pending', 'In Progress', 'Completed', 'On Hold', 'Cancelled'];
    ...
    return (
        <Box sx={{ p: 0 }}>
            ...
            <Paper elevation={0} sx={{
                ...
                <TaskIcon />
                <Typography variant="h6" fontWeight="500">Update Approved Task</Typography>
            </Paper>
            ...
            <Paper sx={{ p: 3, mb: 1, borderRadius: '0 0 8px 8px' }}>
                <Grid container spacing={2}>
                    ...
                    <Grid size={{ xs: 12, md: 6 }}>
                        <Box display="flex" alignItems="center">
                            <Typography sx={{ width: 140, color: 'text.secondary', fontSize: '0.9rem' }}>Task Status</Typography>
                            <Select size="small" fullWidth displayEmpty value={taskStatus} onChange={(e) => setTaskStatus(e.target.value)}>
                                <MenuItem value=""><em>Choose Task Status...</em></MenuItem>
                                {taskStatuses.map(s => (
                    ...
                    <Grid size={{ xs: 12 }}>
                        <Box display="flex" alignItems="center" gap={1}>
                            ...
                            <Box display="flex" alignItems="center" gap={0} sx={{ border: '1px solid #ddd', borderRadius: 1, overflow: 'hidden' }}>
                                <TextField size="small" placeholder="From" sx={{ '& .MuiOutlinedInput-notchedOutline': { border: 'none' }, width: 150 }} />
                                <Box sx={{ px: 1, bgcolor: '#f0f0f0', py: 1, borderLeft: '1px solid #ddd', borderRight: '1px solid #ddd', fontSize: '0.8rem' }}>To</Box>
                                <TextField size="small" placeholder="To" sx={{ '& .MuiOutlinedInput-notchedOutline': { border: 'none' }, width: 150 }} />
                            </Box>
            ...
            <Accordion sx={{ mb: 1, boxShadow: 1, borderRadius: '4px !important', bgcolor: '#e0e0e0' }}>
                <AccordionSummary expandIcon={<ExpandMoreIcon />}>
                    <Box display="flex" alignItems="center" gap={1}>
                        ...
                        <Typography fontWeight="500">Fill Global Data</Typography>
                    </Box>
                </AccordionSummary>
                <AccordionDetails sx={{ bgcolor: 'white' }}>
                    <Typography variant="body2" color="text.secondary">Global data fields will appear here.</Typography>
                </AccordionDetails>
            </Accordion>
