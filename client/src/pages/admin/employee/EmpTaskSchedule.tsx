        ...
        <Box sx={{ p: { xs: 2, md: 3 } }}>
            ...
            <Paper sx={{ p: 3, mb: 4, borderRadius: 2, overflow: 'hidden', boxShadow: '0 4px 20px rgba(0, 0, 0, 0.05)' }}>
                <Grid container spacing={3}>
                    ...
                    <Grid size={{ xs: 12, md: 6 }}>
                        <Box display="flex" flexDirection={{ xs: 'column', md: 'row' }} alignItems={{ xs: 'flex-start', md: 'center' }} gap={{ xs: 0.5, md: 2 }}>
                            <Typography sx={{ color: 'text.secondary', fontSize: 13, width: { xs: '100%', md: 100 } }}>Department</Typography>
                            <FormControl size="small" fullWidth>
                                <Select displayEmpty value={filterData.department} onChange={handleChange('department')} sx={{ borderRadius: 1.5 }}>
