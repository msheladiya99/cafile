                ...
                <Box display="grid" gridTemplateColumns={{ xs: '1fr', md: 'repeat(12, 1fr)' }} gap={3} alignItems="center">
                    ...
                    <Box gridColumn={{ xs: 'span 1', md: 'span 6' }}>
                        <Box display="flex" alignItems="center" gap={2}>
                            <Typography sx={{ color: 'text.secondary', fontSize: 13, width: 120 }}>Group Name</Typography>
                    ...
                    <Box gridColumn={{ xs: 'span 1', md: 'span 6' }}>
                        <Box display="flex" alignItems="center" gap={2}>
                            <Typography sx={{ color: 'text.secondary', fontSize: 13, width: 120 }}>Client Name</Typography>
                            <FormControl size="small" fullWidth>
                    ...
                    <Box gridColumn={{ xs: 'span 1', md: 'span 6' }}>
                        <Box display="flex" alignItems="center" gap={2}>
                            <Typography sx={{ color: 'text.secondary', fontSize: 13, width: 120 }}>Task</Typography>
                            <FormControl size="small" fullWidth>
                    ...
                    <Box gridColumn={{ xs: 'span 1', md: 'span 6' }}>
                        <Box display="flex" alignItems="center" gap={2}>
                            <Typography sx={{ color: 'text.secondary', fontSize: 13, width: 120 }}>Frequency</Typography>
                            <FormControl size="small" fullWidth>
                    ...
                    <Box gridColumn={{ xs: 'span 1', md: 'span 6' }}>
                        <Box display="flex" alignItems="center" gap={2}>
                            <Typography sx={{ color: 'text.secondary', fontSize: 13, width: 120 }}>Reporting Manager</Typography>
                            <FormControl size="small" fullWidth>
                    ...
                    <Box gridColumn={{ xs: 'span 1', md: 'span 6' }}>
                        <Box display="flex" alignItems="center" gap={2}>
                            <Typography sx={{ color: 'text.secondary', fontSize: 13, width: 120 }}>Year</Typography>
                            <FormControl size="small" fullWidth>
                    ...
                    <Box gridColumn={{ xs: 'span 1', md: 'span 6' }}>
                        <Box display="flex" alignItems="center" gap={2}>
                            <Typography sx={{ color: 'text.secondary', fontSize: 13, width: 120 }}>Status</Typography>
                            <FormControl size="small" fullWidth>
                    ...
                    <Box gridColumn={{ xs: 'span 1', md: 'span 6' }}>
                        <Box display="flex" alignItems="center" gap={2}>
                            <Typography sx={{ color: 'text.secondary', fontSize: 13, width: 120 }}>Approval Status</Typography>
                            <FormControl size="small" fullWidth>
                                <Select displayEmpty value={filterData.approvalStatus} onChange={handleChange('approvalStatus')}>
