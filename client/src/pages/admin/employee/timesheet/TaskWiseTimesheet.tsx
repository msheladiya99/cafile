                ...
                <Grid container spacing={3} alignItems="center">
                    ...
                    <Grid size={{ xs: 12, md: 6 }}>
                        <Box display="flex" flexDirection={{ xs: 'column', md: 'row' }} alignItems={{ xs: 'flex-start', md: 'center' }} gap={{ xs: 0.5, md: 2 }}>
                            <Typography sx={{ color: 'text.secondary', fontSize: 13, width: { xs: '100%', md: 120 } }}>Group Name</Typography>
                    ...
                    <Grid size={{ xs: 12, md: 6 }}>
                        <Box display="flex" flexDirection={{ xs: 'column', md: 'row' }} alignItems={{ xs: 'flex-start', md: 'center' }} gap={{ xs: 0.5, md: 2 }}>
                            <Typography sx={{ color: 'text.secondary', fontSize: 13, width: { xs: '100%', md: 120 } }}>Client Name</Typography>
                            <FormControl size="small" fullWidth>
                    ...
                    <Grid size={{ xs: 12, md: 6 }}>
                        <Box display="flex" flexDirection={{ xs: 'column', md: 'row' }} alignItems={{ xs: 'flex-start', md: 'center' }} gap={{ xs: 0.5, md: 2 }}>
                            <Typography sx={{ color: 'text.secondary', fontSize: 13, width: { xs: '100%', md: 120 } }}>Task</Typography>
                            <FormControl size="small" fullWidth>
                    ...
                    <Grid size={{ xs: 12, md: 6 }}>
                        <Box display="flex" flexDirection={{ xs: 'column', md: 'row' }} alignItems={{ xs: 'flex-start', md: 'center' }} gap={{ xs: 0.5, md: 2 }}>
                            <Typography sx={{ color: 'text.secondary', fontSize: 13, width: { xs: '100%', md: 120 } }}>Frequency</Typography>
                            <FormControl size="small" fullWidth>
                    ...
                    <Grid size={{ xs: 12, md: 6 }}>
                        <Box display="flex" flexDirection={{ xs: 'column', md: 'row' }} alignItems={{ xs: 'flex-start', md: 'center' }} gap={{ xs: 0.5, md: 2 }}>
                            <Typography sx={{ color: 'text.secondary', fontSize: 13, width: { xs: '100%', md: 120 } }}>Reporting Manager</Typography>
                            <FormControl size="small" fullWidth>
                    ...
                    <Grid size={{ xs: 12, md: 6 }}>
                        <Box display="flex" flexDirection={{ xs: 'column', md: 'row' }} alignItems={{ xs: 'flex-start', md: 'center' }} gap={{ xs: 0.5, md: 2 }}>
                            <Typography sx={{ color: 'text.secondary', fontSize: 13, width: { xs: '100%', md: 120 } }}>Year</Typography>
                            <FormControl size="small" fullWidth>
                    ...
                    <Grid size={{ xs: 12, md: 6 }}>
                        <Box display="flex" flexDirection={{ xs: 'column', md: 'row' }} alignItems={{ xs: 'flex-start', md: 'center' }} gap={{ xs: 0.5, md: 2 }}>
                            <Typography sx={{ color: 'text.secondary', fontSize: 13, width: { xs: '100%', md: 120 } }}>Status</Typography>
                            <FormControl size="small" fullWidth>
                    ...
                    <Grid size={{ xs: 12, md: 6 }}>
                        <Grid container spacing={1} alignItems="center">
                            <Grid size={{ xs: 12, md: 'auto' }}>
                                <FormControl size="small" fullWidth sx={{ width: { xs: '100%', md: 140 } }}>
                    ...
                    <Grid size={{ xs: 12, md: 6 }}>
                        <Box display="flex" flexDirection={{ xs: 'column', md: 'row' }} alignItems={{ xs: 'flex-start', md: 'center' }} gap={{ xs: 0.5, md: 2 }}>
                            <Typography sx={{ color: 'text.secondary', fontSize: 13, width: { xs: '100%', md: 120 } }}>Approval Status</Typography>
                            <FormControl size="small" fullWidth>
                                <Select displayEmpty value={filterData.approvalStatus} onChange={handleChange('approvalStatus')} sx={{ borderRadius: 1.5 }}>
                                    <MenuItem value="" disabled>Choose a Approval Status...</MenuItem>
                                    {approvalStatuses.map((status) => <MenuItem key={status} value={status}>{status}</MenuItem>)}
                                </Select>
                            </FormControl>
                        </Box>
                    </Grid>
