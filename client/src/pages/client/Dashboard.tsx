    ...
    if (isLoadingStats) {
        return (
            <Container maxWidth="xl" sx={{ py: 4 }}>
                <Box mb={5}>
                    <Skeleton variant="text" width="40%" height={60} sx={{ mb: 1, borderRadius: 2 }} animation="wave" />
                    <Skeleton variant="text" width="20%" height={24} sx={{ borderRadius: 1 }} animation="wave" />
                </Box>
                <Grid container spacing={3} mb={5}>
                    {[1, 2, 3].map(i => (
                        <Grid size={{ xs: 12, sm: 6, md: 4 }} key={i}>
                            <Skeleton variant="rectangular" height={140} sx={{ borderRadius: 4 }} animation="wave" />
                        </Grid>
                    ))}
                </Grid>
